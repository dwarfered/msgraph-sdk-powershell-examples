...
# Microsoft Graph
$msGraphAppRolesAssigned = Get-AppRolesAssignedToServicePrincipalsFromAppId -AppId '00000003-0000-0000-c000-000000000000'
# Windows Azure Active Directory (AAD Graph)
$aadGraphAppRolesAssigned = Get-AppRolesAssignedToServicePrincipalsFromAppId -AppId '00000002-0000-0000-c000-000000000000'
# Office 365 Exchange Online 
$o365ExoAppRolesAssigned = Get-AppRolesAssignedToServicePrincipalsFromAppId -AppId '00000002-0000-0ff1-ce00-000000000000'
# Office 365 Management APIs
$o365MgmtApiRolesAssigned = Get-AppRolesAssignedToServicePrincipalsFromAppId -AppId 'c5393580-f805-4401-95e8-94b7a6ef2fc2'
