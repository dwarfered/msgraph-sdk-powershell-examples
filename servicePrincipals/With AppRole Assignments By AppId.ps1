...
<#
    .SYNOPSIS
    Retrieve Service Principal Application Roles assigned to other Service Principals.
...
function Get-ServicePrincipalAppRolesAssigned {
    [CmdletBinding()]
...
<# Further Microsoft first-party AppIds
https://learn.microsoft.com/en-us/troubleshoot/azure/active-directory/verify-first-party-apps-sign-in
#>

# Microsoft Graph
$msGraphAppRolesAssigned = Get-ServicePrincipalAppRolesAssigned -AppId '00000003-0000-0000-c000-000000000000'
# Windows Azure Active Directory (AAD Graph)
$aadGraphAppRolesAssigned = Get-ServicePrincipalAppRolesAssigned -AppId '00000002-0000-0000-c000-000000000000'
# Office 365 Exchange Online 
$o365ExoAppRolesAssigned = Get-ServicePrincipalAppRolesAssigned -AppId '00000002-0000-0ff1-ce00-000000000000'
# Office 365 Management APIs
$o365MgmtApiRolesAssigned = Get-ServicePrincipalAppRolesAssigned -AppId 'c5393580-f805-4401-95e8-94b7a6ef2fc2'
